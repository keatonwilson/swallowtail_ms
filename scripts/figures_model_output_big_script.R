...
g11 = ggplot(data = swallowtail_inset, aes(x = year, y = max_lat, size = n)) +
  ...
  annotate(geom = "text", label = "Timeframe Break Point", x = 1993, y = 47.5)
...
# Building figures for manuscript -----------------------------------------

# Figure 1 Evidence of northward shift from occurence data------------------------------------------------- 
#Panel A
...
#Overall Trends?
annual_mean_temp_1 = extract(bv_t1$Bio1, c(1:434304))
annual_mean_temp_2 = extract(bv_t2$Bio1, c(1:434304))
mean(annual_mean_temp_1, na.rm = TRUE)
sd(annual_mean_temp_1, na.rm = TRUE)

mean(annual_mean_temp_2, na.rm = TRUE)
sd(annual_mean_temp_2, na.rm = TRUE)

test = t.test(annual_mean_temp_1, annual_mean_temp_2, paired = TRUE)

bioclim_6_1 = extract(bv_t1$Bio6, c(1:434304))
bioclim_6_2 = extract(bv_t2$Bio6, c(1:434304))
mean(bioclim_6_1, na.rm = TRUE)
sd(bioclim_6_1, na.rm = TRUE)

mean(bioclim_6_2, na.rm = TRUE)
sd(bioclim_6_2, na.rm = TRUE)
test = t.test(bioclim_6_1, bioclim_6_2, paired = TRUE)

bioclim_8_1 = extract(bv_t1$Bio8, c(1:434304))
bioclim_8_2 = extract(bv_t2$Bio8, c(1:434304))
mean(bioclim_8_1, na.rm = TRUE)
sd(bioclim_8_1, na.rm = TRUE)

mean(bioclim_8_2, na.rm = TRUE)
sd(bioclim_8_2, na.rm = TRUE)
test = t.test(bioclim_8_1, bioclim_8_2, paired = TRUE)

bioclim_10_1 = extract(bv_t1$Bio10, c(1:434304))
bioclim_10_2 = extract(bv_t2$Bio10, c(1:434304))
mean(bioclim_10_1, na.rm = TRUE)
sd(bioclim_10_1, na.rm = TRUE)

mean(bioclim_10_2, na.rm = TRUE)
sd(bioclim_10_2, na.rm = TRUE)
test = t.test(bioclim_10_1, bioclim_10_2, paired = TRUE)
