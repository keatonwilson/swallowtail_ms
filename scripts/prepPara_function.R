#prepPara function from https://github.com/shandongfx/workshop_maxent_R/tree/master/code
#
#Function that allows a user to modify deeper parameters of MaxEnt
